...
function uc_avatar($uid, $type = 'virtual', $returnhtml = 1) {
	...
	if($returnhtml) {
		...
		width="520" height="280" id="mycamera" align="middle">
			...
			<embed src="' . $uc_avatarflash . '" quality="high" bgcolor="#ffffff" width="520" height="280" name="mycamera" align="middle" allowScriptAccess="always" allowFullScreen="false" scale="exactfit"  wmode="transparent" type="application/x-shockwave-flash" pluginspage="http://www.macromedia.com/go/getflashplayer" />
		</object>';
	} else {
		return array(
			'width', '447',
