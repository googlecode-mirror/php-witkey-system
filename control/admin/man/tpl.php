 ...
 * 2010-6-28 18:17:13
 */
class Control_admin_man_tpl extends Controller{
	/**
	 * @var 跳转用
	 */
	private  $_uri;
	...
	function before(){
		$this->_uri = "index.php/admin/man_tpl";
	}
	function action_index(){
		...
		require Keke_tpl::template('control/admin/tpl/man/tpl');
	}
	/**
	 * 编辑模板列表
	 */
	function action_list(){
		...
		require Keke_tpl::template ( 'control/admin/tpl/man/tpl_file_list');
	}
	/**
	 * 安装模板
	 */
...
// 			$config_tpl_obj->setWhere ( "tpl_path ='$txt_newtplpath'" );
	...
	function action_edit(){
		...
		require Keke_tpl::template('control/admin/tpl/man/tpl_file_edit');
	}
	/**
	 * 保存编辑的模板文件
	 */
	function action_tpl_save(){
		...
		if ($_POST) {
			...
			if (! is_writable ( $filename )) {
				Keke::show_msg ($_lang ['operate_notice'],"index.php/admin/man_tpl/eidt?tplname=$tplname&tname=$tname",$_lang['file'] . $filename . $_lang['can_not_write_please_check'], 'warning' );
			}
			...
			Keke::show_msg ($_lang ['operate_notice'],"index.php/admin/man_tpl/edit?tplname=$tplname&tname=$tname", $_lang['tpl_edit_success'],'success',2 );
		}
	}
