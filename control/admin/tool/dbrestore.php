...
class Control_admin_tool_dbrestore extends Controller{
	...
	function action_del(){
		...
		if ($res) {
			...
			//Keke::show_msg('系统提示','index.php/admin/tool_dbrestore',$_lang['delete_database_backup_file_success'],'success');
			//Keke::admin_show_msg ( $_lang['delete_database_backup_file_success'], 'index.php?do=' . $do . '&view=' . $view ,3,'','success');
		} else {
			Keke::show_msg('系统提示','index.php/admin/tool_dbrestore',$_lang['delete_database_backup_file_fail'],'warning');
			echo 0;
