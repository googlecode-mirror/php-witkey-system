...
class Control_task_dtender_admin_list extends Control_task_list{
	/**
	 * @var 模型代码
	 */
    ...
    function action_index(){
    	...
    	$task_status = Control_task_dtender_task::get_task_status();
    ...
    public function action_add(){
        ...
        //订金任务状态
        $status_arr = Control_task_dtender_task::get_task_status();
        //获取任务的增值项
