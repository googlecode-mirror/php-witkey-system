...
class Control_task_tender_admin_list extends Control_admin_task_list{
	/**
	 * @var 模型代码
	 */
    ...
    function action_index(){
    	global $_K,$_lang;
//     	var_dump(self::get_work_file('598'));
    	...
    	$task_status = Control_task_tender_task::get_task_status();
    ...
    public function action_add(){
        ...
        //普招任务状态
        $status_arr = Control_task_tender_task::get_task_status();
        //获取任务的增值项
...
//      $data_info = Model::factory('witkey_task')->get_grid($fields,$where,$uri,$order,$page,$count,$_GET['page_size']);
        ...
        //分页数据
        $pages = $data_info['pages'];
        $satus_arr = Control_task_tender_task::get_work_status();
    ...
    public function action_work_del(){
    	...
    	//删除关联的三张表
    	$sql = "delete a,b from ".TABLEPRE."witkey_task_bid as a \n".
