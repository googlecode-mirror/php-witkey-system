 ...
 */
	error_reporting(0);
  	...
  	require_once '../class/inc/keke_base_class.php';
  	require_once '../class/inc/keke_tpl_class.php';
  	require_once '../class/inc/keke_lang_class.php';
  	require_once '../class/helper/file.php';
