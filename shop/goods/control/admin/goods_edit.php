...
if($sbt_edit){
	...
	$res and kekezu::admin_show_msg($_lang['goods_edit_success'],'index.php?do=model&model_id=6&view=list',2,$_lang['goods_edit_success'],'success') or kekezu::admin_show_msg($_lang['goods_edit_fail'],'index.php?do=model&model_id=6&view=edit&service_id='.$service_id,2,$_lang['goods_edit_fail'],'warning');
}
if($file_path){
