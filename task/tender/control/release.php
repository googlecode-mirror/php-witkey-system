...
$release_obj = tender_release_class::get_instance ( $model_id ,$pub_mode);
...
$min =time()+ 24*3600;
$min = date("Y-m-d",$min); 
$payitem_arr = keke_payitem_class::get_payitem_info('employer','tender'); //获取该任务所有的增值服务  
...
$max =$task_config['zb_max_time']  ;
$max =date('Y-m-d',time()+ 24*3600*$max);
