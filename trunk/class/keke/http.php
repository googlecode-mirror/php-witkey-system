...
abstract class Keke_HTTP {
	...
	public static function parse_header_string($header_string)
	{
		...
		if (extension_loaded('http'))
		{
			...
			return new Keke_HTTP_Header(http_parse_headers($header_string));
		}
		...
		// Return the headers
		return new Keke_HTTP_Header($headers);
	}
	...
	public static function request_headers()
	{
		...
		if (function_exists('apache_request_headers'))
		{
			...
			return new Keke_HTTP_Header(apache_request_headers());
		}
		// If the PECL HTTP tools are installed
		elseif (extension_loaded('http'))
		{
			// Return the much faster method
			return new Keke_HTTP_Header(http_get_request_headers());
		}
