...
if ($need_index_art)
{
    ...
    kekezu::admin_system_log($_lang['mulit_edit_cate'] . $record_id); //日志记录
}
...
if (isset ( $sbt_action )) 
{
	...
	if($res)
	{
		kekezu::admin_show_msg($_lang['mulit_operate_success'],'index.php?do='.$do.'&view='.$view.'&type='.$type,3,'','success');//批量操作成功
	}
	else
	{
