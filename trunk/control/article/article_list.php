...
$static and ($type=='archive' and $url = $_K['siteurl']."/html/article/archive/{$year}_" or $url = $_K['siteurl']."/html/article/list/{$art_cat_id}_") or  $url = "index.php?do=article&art_cat_id=$art_cat_id&page_size=$page_size&year=$year";
