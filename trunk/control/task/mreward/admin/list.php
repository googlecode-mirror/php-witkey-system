...
class Control_task_mreward_admin_list extends Control_admin_task_list{
	/**
	 * @var 模型代码
	 */
    ...
    public function action_add(){
        ...
        //多赏任务状态
        $status_arr = Control_task_mreward_task::get_task_status();
        //获取任务的增值项
...
//      $data_info = Model::factory('witkey_task')->get_grid($fields,$where,$uri,$order,$page,$count,$_GET['page_size']);
        ...
        //分页数据
        $pages = $data_info['pages'];
        $satus_arr = Control_task_mreward_task::get_work_status();
