		...
		if ($ser_id) {
			switch ($ac) {
				case "del" :
					...
					$res and kekezu::show_msg ( $_lang ['operate_notice'], $url, 1, $_lang ['g_delete_success'], 'alert_right' ) or kekezu::show_msg ( $_lang ['operate_notice'], $url, 1, $_lang ['g_delete_fail'], 'alert_error' );
					break;
				case "edit" :
