...
$init_menu = array(
	$_lang['task_manage']=>'index.php?do=model&model_id=10&view=list&status=0',
	$_lang['task_config']=>'index.php?do=model&model_id=10&view=config',
